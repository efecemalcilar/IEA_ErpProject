...
namespace IEA_ErpProject.BilgiGiris.Hastaneler
{
    ...
    {
        public readonly Entity.ErpPro102SEntities _db = new Entity.ErpPro102SEntities();
        ...
        private void Listele()
        {
            ...
            var hstDetayList = (from s in _db.tblHastaneDetaylar where s.GirisAdi == "H" where s.tblHastaneler.Adi == Hadi select s).ToList();
